    ...
    <div  class="grid grid-cols-1 md:grid-cols-3 gap-5 p-8">
      <div v-for="meal of meals" :key="meal.idMeal" class="bg-white shadow rounded-xl">
        ...
        <div class="p-3">
          ...
          class="px-3 py-2 rounded-lg text-white border-2 border-red-600  bg-red-500 hover:bg-red-600  transition-colors">Youtube</a>
          <!-- <router-link  to="/"  
          class="px-3 py-2 rounded-lg text-white border-2 border-purple-600 bg-purple-500 hover:bg-purple-600  transition-colors">
            View
          </router-link> -->
        </div>
        </div>
